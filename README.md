...
Proof of concept wallet for the [Digital Credential API](https://github.com/w3c-fedid/digital-credentials) accepting Estonian ID card self-signed authentication credential in [ISO/IEC 18013-5](https://www.iso.org/standard/69084.html) format.
To test the authentication flow, use the [eid-dca-verifier](https://github.com/aarmam/eid-dca-verifier).
